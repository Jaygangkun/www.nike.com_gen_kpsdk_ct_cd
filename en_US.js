nike.unite.experience.load({
    "settings": {
      ...
      "environments": {
        "local": {
          "acceptanceServiceUrl": "https://ecn77-api.nikedev.com/rest/acceptance",
          ...
          "lineRedirectURL": "https://local-www.nikedev.com:8080/lineRedirect.html",
          "segmentWriteKey": "VytnEyNFDhlAfENPFuLOHfodwNQLchrv",
          "api": {
            "createUser": {
              "cors": "https://unite.nikedev.com",
        ...
        "ci": {
          ...
          "weChatMiniAppId": "wx4dc68d809dab5a54",
          "lineAppId": "1574313282",
          "lineRedirectURL": "https://s3.nikecdn.com/unite-dev/ci/lineRedirect.html",
          "segmentWriteKey": "VytnEyNFDhlAfENPFuLOHfodwNQLchrv",
          "api": {
            "createUser": {
              "cors": "https://unite.nikedev.com",
          ...
          "analyticsClientDebug": false
        },
        "production": {
          "acceptanceServiceUrl": "https://api.nike.com/rest/acceptance",
          ...
          "lineAppId": "1574313282",
          "lineRedirectURL": "https://s3.nikecdn.com/unite/lineRedirect.html",
          "segmentWriteKey": "267bj73O9ZmyZQ2LUMVgAcLk0q5BieJu",
          "api": {
            "createUser": {
              "cors": "https://unite.nike.com",
              "path": "/access/users/v1"
      ...
      "progressive": {
        ...
        "states": {
          ...
          "hasEmailOptional": {
            "layout": "{{captureEmailHeader}}{{#mobileJoinEmailForm}}{{emailAddress}}{{mobileJoinEmailSubmit}}{{mobileJoinEmailSkipButton}}{{/mobileJoinEmailForm}}",
            "endpoint": "userState"
          },
          "hasFirstAndLastName": {
      ...
      "passwordRedirectURL": "http://www.nike.com",
      "passwordResetEmailTemplate": "TSD_PROF_PASSWORD_RESET_V1.0",
      "welcomeEmailTemplate": "",
      "emailOnlyJoinWelcomeEmailTemplate": "",
      "emailOnlyJoinRedirectURIWhitelist": "^http(s)?://([^/]*\\.)?nike(dev)?\\.com(:[0-9]+)?([\\?/].*)?$",
      "atgSync": false,
      ...
      "swooshEnabled": false,
      "analyticsClientUrl": "https://www.nike.com/assets/measure/data-capture/analytics-client.min.js"
    },
    "views": {
      "appLanding": {
      ...
      "emailOnlyJoin": {
        ...
        "classes": [],
        "layout": "{{coppa}}{{emailOnlyJoinHeaderExperiment}}{{#joinForm}}{{emailAddress}}{{emailOnlyDateOfBirth}}{{shoppingGenderDropdown}}{{emailOnlyJoinSubmit}}{{emailOnlyJoinTerms}}{{/joinForm}}"
      },
      "error": {
      ...
      "join": {
        ...
        "flowOverride": false,
        "classes": [],
        "layout": "{{coppa}}{{joinHeader}}{{#joinForm}}{{socialRegister}}{{emailAddress}}{{passwordCreate}}{{firstName}}{{lastName}}{{dateOfBirth}}{{country}}{{gender}}{{emailSignup}}{{joinTerms}}{{joinSubmit}}{{/joinForm}}{{currentMemberSignIn}}"
      },
      "link": {
      ...
      "updatePassword": {
        ...
        "layout": "{{updatePasswordBlock}}{{errorMessage}}{{#updatePasswordForm}}{{passwordCreate}}{{updatePasswordSubmit}}{{/updatePasswordForm}}"
      },
      "mobileJoin": {
        "src": "nike-unite-join-view",
        "flowOverride": false,
      ...
      "weChatMiniMobileJoinContinue": {
        ...
        "layout": "{{coppa}}{{joinSocialHeader}}{{socialJoinSubheader}}{{#mobileJoinForm}}{{weChatMiniPhone}}{{lastName}}{{firstName}}{{dateOfBirth}}{{passwordCreate}}{{gender}}{{mobileNumberSignup}}{{joinTermsRequired}}{{mobileJoinSubmit}}{{mobileJoinBackButton}}{{/mobileJoinForm}}"
      },
      "mobileLogin": {
        "src": "nike-unite-login-view",
        "flowOverride": "login",
    ...
    "components": {
      ...
      "errorMessageUpdatePasswordPreviousPassword": {
        "type": "errorMessage",
        "messages": [
          {
            "text": "New password must not match a previously used password"
          }
        ]
      },
      "errorMessageLogin": {
      ...
      "errorPanel": {
        ...
        "byKey": {
          ...
          "EmailSignup.dateOfBirth.InvalidCOPPAweb": {
            ...
            "buttonLink": "https://www.nike.com/help/#contact",
            "persistError": true
          },
      ...
      "partnerSubheader": {
        "type": "block",
        "value": "{{partnerImage}}<div id=\"partnerSubheader\" class=\"view-sub-header\">By connecting, you allow {{partnerName}} to:</div>"
      },
      "partnerPermissions": {
        "type": "block",
      ...
      "emailOnlyJoinHeader": {
        "type": "block",
        "value": "<header>{{headerImage}}<div class=\"view-header\">GET NEWS AND OFFERS FROM NIKE</div><div id=\"joinMessage\" class=\"view-sub-header nike-unite-message\">Sign up for email to get special news and offers from the Nike family of brands.</div></header>"
      },
      "emailOnlyJoinHeaderPromo": {
        "type": "block",
        "value": "<header>{{headerImage}}<div class=\"view-header\">GET 10% OFF YOUR FIRST NIKE ORDER</div><div id=\"joinMessage\" class=\"view-sub-header nike-unite-message\">Sign up a new email address, and receive a 10% promotion to be used on your first Nike purchase. Get in the game.</div></header>"
      },
      "emailOnlyJoinHeaderExperiment": {
        "type": "experiment",
        "componentType": "block",
        "experimentKey": "EMAIL_CAPTURE_PROMO",
        "attributes": {},
        "variant": {
          "control": {
            "value": "{{emailOnlyJoinHeader}}"
          },
          "promo": {
            "value": "{{emailOnlyJoinHeaderPromo}}"
          }
        }
      },
      "joinHeader": {
        "type": "block",
        "value": "<header>{{headerImage}}<div class=\"view-header\">BECOME A NIKE MEMBER</div><div id=\"joinMessage\" class=\"view-sub-header nike-unite-message\">Create your Nike Member profile and get first access to the very best of Nike products, inspiration and community.</div></header>"
      },
      ...
      "socialJoinSubheader": {
        "type": "block",
        "value": "<div id=\"socialMessage\" class=\"view-sub-header nike-unite-message\">We have connected with your {{provider}} account.<br/>{{socialIcon}}<span class=\"view-sub-header nike-unite-message\">Complete your profile to finish creating your account.</span></div>"
      },
      "swooshLegalHeader": {
        "type": "block",
      ...
      "joinTermsRequired": {
        "id": "joinTermsRequired",
        "dataField": "joinTermsRequired",
        "type": "checkbox",
        "label": "<p class=\"terms-required\">I agree to Nike's <a {{policyLink}}>Privacy Policy</a> and <a {{termsLink}}>Terms of Use</a>.</p>",
        "tip": "",
        "value": false,
        "active": true,
        "rules": [
      ...
      "participantLink": {
        "type": "block",
        "value": "href=\"https://www.nike.com/member/settings/connected-apps\""
      },
      "joinForm": {
        "id": "joinForm",
        "type": "form",
      ...
      "mobileFAQLink": {
        "type": "block",
        "value": "href=\"http://help-en-us.nike.com/app/answers/detail/article/nike-mobile-verification\""
      },
      "mobileHelpNumber": {
        "type": "block",
        "value": "800-806-6453"
      ...
      "dateOfBirth": {
        ...
        "mmLabel": "mm",
        "yyyyLabel": "yyyy",
        "message": "Get a Nike Member Reward every year on your Birthday.",
        "rules": [
          {
            "active": true,
            "name": "crossField",
      ...
      "mobileJoinEmailSubmit": {
        "type": "submitButton",
        "label": "SAVE",
        "labelProcessing": "PROCESSING…",
        "formId": "mobileJoinEmailForm"
      },
      "mobileJoinEmailSkipButton": {
        "type": "actionButton",
        "label": "SKIP",
        "view": "mobileJoin",
        "action": "skip"
